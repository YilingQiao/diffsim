...
max_line    = 2
max_length  = 0.9
unit_length = max_length / (max_line -1)
...
for i in range(max_line):
	for j in range(max_line):
		...
		new_cube['transform']['translate'][1] -= unit_length * (i)
		new_cube['transform']['translate'][0] -= unit_length * (j)
...
save_config(config, "multibody_make.json")
