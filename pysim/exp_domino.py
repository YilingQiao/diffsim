			...
			for obstacle in sim.obstacles:
				...
				if  x[5]<0.4:
					...
					obstacle.curr_state_mesh.dummy_node.v = torch.cat(
						[ obstacle.curr_state_mesh.dummy_node.v.narrow(0, 0, 1)*0.5,
						obstacle.curr_state_mesh.dummy_node.v.narrow(0, 1, 1),
						obstacle.curr_state_mesh.dummy_node.v.narrow(0, 2, 1)*0.5,
