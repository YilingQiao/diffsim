...
class EnvMan(object):
    ...
    def __init__(self):
        ...
        if not os.path.exists('../200216_bounce/'):
            os.mkdir('../200216_bounce/')
        self.save_config(config, '../200216_bounce/conf.json')
    ...
    def reset(self):
        with torch.no_grad():
            ...
            if self.epoch <= 20:
                arcsim.init_physics('../200216_bounce/conf.json','../200216_bounce/out_cmaes%d'%self.epoch,False)
                ...
                arcsim.init_physics('../200216_bounce/conf.json', '../200216_bounce/out_cmaes',False)
